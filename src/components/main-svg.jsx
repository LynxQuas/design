export default function MainSvg() {
    return (
        <svg
            ...
            className="icon bounce-custom w-16 h-16"
            version="1.1"
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                ></path>
                <path
                    d="M700.2 388.3m-15.8 0a15.8 15.8 0 1 0 31.6 0 15.8 15.8 0 1 0-31.6 0Z"
                    fill="#004364"
                ></path>
                <path
                    d="M757.3 431.7m-15.8 0a15.8 15.8 0 1 0 31.6 0 15.8 15.8 0 1 0-31.6 0Z"
                    fill="#004364"
                ></path>
                <path
                    d="M688.2 457.6m-15.8 0a15.8 15.8 0 1 0 31.6 0 15.8 15.8 0 1 0-31.6 0Z"
                    fill="#004364"
                ></path>
                <path
                    d="M427.8 824.4m-15.8 0a15.8 15.8 0 1 0 31.6 0 15.8 15.8 0 1 0-31.6 0Z"
                    fill="#004364"
                ></path>
                <path
                    d="M357 787.8m-15.8 0a15.8 15.8 0 1 0 31.6 0 15.8 15.8 0 1 0-31.6 0Z"
                    fill="#004364"
                ></path>
            </g>
        </svg>
